...
class TopProvidersState extends BaseWidget {
    use HasWidgetShield;
    protected static ?int $sort = 7;
    public function table(Table $table): Table {
        return $table
            ->heading(__('sections.providers_by_state'))
            ->query(fn()=>State::withCount('providers')->orderBy("providers_count", 'desc')->limit(20))
            ->columns([
                TextColumn::make('index')->rowIndex(),
                TextColumn::make('name')->label(__("forms.fields.state_name")),
