...
class SpecializationPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\CatalogModule\Models\Specialization  $specialization
     * @return bool
     */
    ...
    {
        return $user->can('delete_any_specialization');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Specialization $specialization): bool
    {
