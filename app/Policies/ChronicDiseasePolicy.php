...
class ChronicDiseasePolicy
{
    ...
    {
        return $user->can('view_any_chronic::disease');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\ContentModule\Models\ChronicDisease  $chronicDisease
     * @return bool
     */
    ...
    {
        return $user->can('create_chronic::disease');
    }
    ...
    {
        return $user->can('update_chronic::disease');
    }
    ...
    {
        return $user->can('delete_chronic::disease');
    }
    ...
    {
        return $user->can('delete_any_chronic::disease');
    }
