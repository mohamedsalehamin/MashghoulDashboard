...
class CustomerReviewPolicy
{
    ...
    {
        return $user->can('view_any_customer::review');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\ContentModule\Models\CustomerReview  $customerReview
     * @return bool
     */
    ...
    {
        return $user->can('create_customer::review');
    }
    ...
    {
        return $user->can('update_customer::review');
    }
    ...
    {
        return $user->can('delete_customer::review');
    }
    ...
    {
        return $user->can('delete_any_customer::review');
    }
