...
class ReservationProcessingUnfinisedNotification extends Notification {
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.reservationupdatestatusnotification', ['id' => $this->reservation->id])
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.reservationupdatestatusnotificationody', ['id' => $this->reservation->id])
