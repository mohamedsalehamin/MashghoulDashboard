...
class PatientRejectScheduleReservationNotification extends Notification {
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->doctorMessage('panel.notifications.patientrejectschedulereservationnotification', ['id' => $this->reservation->id])
            ->parse();
    }
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->doctorMessage('panel.notifications.patientrejectschedulereservationnotificationbody', ['id' => $this->reservation->id])
            ->parse();
    }
}
