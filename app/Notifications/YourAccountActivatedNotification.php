...
class YourAccountActivatedNotification extends Notification {
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.youraccountactivatednotification')
            ->doctorMessage('panel.notifications.youraccountactivatednotification')
            ->parse();
    }
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.youraccountactivatednotificationbody')
            ->doctorMessage('panel.notifications.youraccountactivatednotificationbody')
            ->parse();
    }
}
