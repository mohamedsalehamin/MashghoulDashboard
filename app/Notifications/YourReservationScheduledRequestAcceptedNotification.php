...
class YourReservationScheduledRequestAcceptedNotification extends Notification
{
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.yourreservationscheduledrequestacceptednotification',['reservation_id'=>$this->reservation->id])
            ->parse();
    }
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.yourreservationscheduledrequestacceptednotificationbody',['reservation_id'=>$this->reservation->id])
            ->parse();
    }
}
