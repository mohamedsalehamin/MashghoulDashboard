...
class RemindingPatientOfReservationDateNotification extends Notification {
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.remindingpatientofreservationdatenotification', ['id' => $this->reservation->id])
            ->parse();
    }
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->customerMessage('panel.notifications.remindingpatientofreservationdatenotificationbody', ['id' => $this->reservation->id])
            ->parse();
    }
}
