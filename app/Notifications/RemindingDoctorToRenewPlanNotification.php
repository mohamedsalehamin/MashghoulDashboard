...
class RemindingDoctorToRenewPlanNotification extends Notification
{
    use Queueable;
    ...
    public function getTitle($notifiable) {
        return NotificationMessageParser::init($notifiable)
            ->doctorMessage('panel.notifications.remindingdoctortorenewplannotification')
            ->parse();
    }
    ...
    public function getBody($notifiable) {
        ...
        return NotificationMessageParser::init($notifiable)
            ->doctorMessage('panel.notifications.remindingdoctortorenewplannotificationbody')
            ->parse();
    }
}
