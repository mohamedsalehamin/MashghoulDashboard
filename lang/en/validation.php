...
return [
    ...
    */
    ...
    'api' => [
        "overdue_points_balance" => 'Overdue points balance',
        ...
        'current_branch_cant_provide_takeaway_method'=>'Current Branch cant provide takeaway',
        ...
        'coupon_requires_services_in_cart' => 'This code applies to services only. Add a service to your booking, then try again.',
        'coupon_requires_non_sale_services' => 'This code applies to services that are not on sale. Your selection has no eligible services.',
        'coupon_requires_non_sale_items' => 'This code applies to items not on sale. Your cart has no eligible services or products.',
        'coupon_requires_services_or_products' => 'Your cart has no eligible services or products for this code.',
        'coupon_admin_needs_reservation_fee' => 'This code applies to the reservation fee only. A reservation fee must apply to your booking.',
        'coupon_discount_not_applicable' => 'The discount could not be applied to your current cart.',
