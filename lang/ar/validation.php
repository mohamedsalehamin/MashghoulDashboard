...
return [
    ...
    */
    ...
    'phone_exists_in_join_requests' => 'تم تسجيل رقم الجوال هذا بالفعل كطلب انضمام.',
    'phone_exists_in_providers' => 'تم تسجيل رقم الجوال هذا بالفعل كمقدم خدمة، يرجى استخدام رقم جوال آخر',
    'phone_exists_in_customers' => 'رقم الجوال هذا مسجل بالفعل كعميل، يرجى استخدام رقم جوال آخر.',
    ...
    */
    ...
    'api' => [
        ...
        'coupon_requires_services_in_cart' => 'هذا الكود يخص الخدمات فقط. أضف خدمة إلى حجزك ثم أعد المحاولة.',
        'coupon_requires_non_sale_services' => 'هذا الكود يخص الخدمات غير المعروضة بتخفيض. لا توجد خدمات مؤهلة في اختيارك.',
        'coupon_requires_non_sale_items' => 'هذا الكود يخص العناصر غير المخفضة فقط. لا توجد خدمات أو منتجات مؤهلة في سلتك.',
        'coupon_requires_services_or_products' => 'لا توجد خدمات أو منتجات مؤهلة في سلتك لهذا الكود.',
        'coupon_admin_needs_reservation_fee' => 'هذا الكود يخص رسوم الحجز فقط. يجب أن تنطبق رسوم حجز على حجزك.',
        'coupon_discount_not_applicable' => 'تعذر تطبيق الخصم على سلتك الحالية.',
        ...
        'no_active_subscription' => 'لا يوجد اشتراك فعّال. يرجى تجديد الباقة من بوابة مقدمي الخدمة أو إكمال الدفع.',
        'subscription_details' => 'تفاصيل الاشتراك',


    ],
    'translatable_required.missing' => 'حقل :attribute مطلوب في :locales.',
    'tabby' => [
        ...
        'redirect_cancel' => 'تم إلغاء عملية الدفع. يرجى المحاولة مرة أخرى أو اختيار طريقة دفع أخرى.',
        'redirect_failure' => 'تم رفض عملية الدفع. يرجى المحاولة مرة أخرى أو اختيار طريقة دفع أخرى.',
    ]
];
