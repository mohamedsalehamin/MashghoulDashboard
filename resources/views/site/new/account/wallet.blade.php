...
<div class="container">
    <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb" class="my-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('site.heading.wallet')  }}</li>
        </ol>
    </nav>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="section-title fz32">{{ __('site.heading.wallet') }}</div>
                @livewire('site.profile-wallet-list')
            </div>
        </div>
    </div>
</div>
