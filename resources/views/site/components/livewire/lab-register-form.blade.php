<div id="registerForm" class="bs-stepper">
    <div class="steps-header" role="tablist">
        ...
        <div class="step @if($step==3)active  @endif" data-target="#step-3">
            <button
                ...
                wire:click="navigateTo(3)"
            >
                <span> 3 </span>
                @lang('site.heading.lab_data')
            </button>
        </div>
    </div>
        ...
        <form>
            ...
            <div class="form-content">
                <div class="form-group">
                    <label class="form-label"> @lang('site.fields.full_name')  <span class="text-danger">*</span></label>
                ...
                <div class="form-group" >
                    <div wire:ignore class="w-100">
                        <label class="form-label">@lang("site.fields.phone")<span class="text-danger">*</span> </label>
                ...
                <div class="form-group">
                    <label class="form-label"> @lang('site.fields.gender') <span class="text-danger">*</span></label>
                    <div class="radios">
                ...
                <div class="form-group">
                    <label class="form-label"> @lang('site.fields.password') <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label class="form-label"> @lang('site.fields.password_confirmation')<span class="text-danger">*</span> </label>
                    <div class="password-content">
                        <button class="password-toggle">
                            <i class="fa-regular fa-eye"></i>
                        </button>
    ...
    <div id="step-3" role="tabpanel" class="bs-stepper-pane  {{$step==3 ?'active':'fade dstepper-none'}}">
        <div class="form-content">
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.doctor_manager_name')<span class="text-danger">*</span> </label>
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.license_number') <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.license_image')<span class="text-danger">*</span> </label>
                <div class="upload-content">
                    <label class="form-control">
                        <input type="file" accept="image/*" wire:model="license_image">
                        @if($license_image)
                            <span class="preview">{{$license_image->getClientOriginalName()}}</span>
                        @endif
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.tax_number')<span class="text-danger">*</span> </label>
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.lab_name') <span class="text-danger">*</span> </label>
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.upload_logo')<span class="text-danger">*</span> </label>
                <div class="upload-content">
                    <label class="form-control">
                        <input type="file" accept="image/*" wire:model="lab_logo">
                        @if($lab_logo)
                            <span class="preview">{{$lab_logo->getClientOriginalName()}}</span>
                        @endif
                        <span class="upload-text">  @lang('site.buttons.add_file') </span>
                    </label>
                </div>
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.lab_images') </label>
                <div class="form-group">
                    <label class="file-content">
                        <input type="file" accept="image/*" wire:model="lab_photos">
                ...
                <div class="files-list">
                    @foreach($lab_photos as $index=>$file)
            ...
            <div class="form-group">
                <label class="form-label"> @lang('site.fields.lab_bio')<span class="text-danger">*</span> </label>
                <textarea class="form-control" wire:model="bio"></textarea>
                @error('bio')
                <span class="form-error">{{$message}}</span>
                @enderror
            </div>
            <livewire:select2 name="country_id" :options="$countries" wire:model.live="country_id" label="{{__('site.fields.country')}}"/>
            ...
            <a wire:click="complete" class="submit-btn main-btn">
