<div class="archive-head">
    <h2 class="search-title">@lang('site.heading.data_result')
    ...
    <div class="search-tools">
        <div class="search-input">
            ...
            <input type="search" placeholder="@lang('site.heading.search_with_doc_name')"
        ...
        <div class="search-sort">
            ...
            <select class="search-select"
                    wire:model.live="$parent.filters.order_by"
            >
                <option selected value="topRated">@lang('site.fields.top_rated')</option>
                <option selected value="nearest">@lang('site.fields.nearest')</option>
                <option selected value="farthest">@lang('site.fields.farthest')</option>
...
<script>
    ...
    navigator.geolocation.getCurrentPosition((position) => {
        $wire.$parent.$set('user_location.lat',position.coords.latitude)
        $wire.$parent.$set('user_location.lng',position.coords.longitude)
