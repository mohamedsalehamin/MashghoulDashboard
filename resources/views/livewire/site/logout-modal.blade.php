<div>
    <div class="modal fade custom-bootstrap-modal" id="logout-modal" tabindex="-1" aria-labelledby="logoutModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center">
                <div class="modal-header d-flex flex-column align-items-center position-relative pb-0">
                    ...
                    <h3 class="modal-title mb-2" id="logoutModalLabel">{{ __('site.heading.logout') }}</h3>
                    <p class="modal-subtitle">{{ __('site.heading.logout_confirm') }}</p>
                </div>
                <div class="modal-footer d-flex flex-row justify-content-center gap-3 pt-0">
                    <button type="button" class="btn btn-green modal-confirm px-5" wire:click="logout">
