...
trait HasJsonRelationships
{
    ...
    public function getAttribute($key)
    {
        ...
        if (array_key_exists($attribute, $this->attributes)) {
            return $this->getActualAttributeValue($key);
        }
     ...
     * @return mixed
     */
    public function getActualAttributeValue($key)
    {
        if (str_contains($key, '->')) {
            ...
            return data_get($this->getActualAttributeValue($key), $path);
        }

        return parent::getActualAttributeValue($key);
    }
