...
enum LabReservationStatus: string implements HasLabel {
    ...
    public function getColor(): string {
        return match ($this->value) {
            ...
            'processing' => 'info',
            'completed' => 'success',
            'doctor_canceled','lab_canceled','system_canceled', 'patient_canceled', 'patient_rescheduled', 'doctor_rescheduled', 'problematic', 'patient_late', 'doctor_late' => 'danger',
        };
