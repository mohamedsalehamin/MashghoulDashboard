...
use App\DefaultPanel\Resources\Api\CancellationReasonResource;
...
class SettingServices {
    ...
    public function cancellationReasons() {
        return Api::isOk("Reasons List")->setData(CancellationReasonResource::collection(CancellationReason::enabled()->latest()->paginate()));
    }

    public function reportReasons() {
        return Api::isOk("Reasons List")->setData(CancellationReasonResource::collection(ReportReason::enabled()->latest()->paginate()));
